...
#import <RyKit/RisingSingleClass.h>
...
- (AFJSONRequestSerializer *)defaultJSONRequest {
    ...
    if (_token) {
        [_defaultJSONRequest setValue:[NSString stringWithFormat:@"Bearer %@", _token] forHTTPHeaderField:@"authorization"];
    }
...
- (AFHTTPRequestSerializer *)HTTPRequest {
    ...
    if (_token) {
        [_HTTPRequest setValue:[NSString stringWithFormat:@"Bearer %@", _token] forHTTPHeaderField:@"authorization"];
    }
    return _HTTPRequest;
}
...
- (AFPropertyListRequestSerializer *)propertyListRequest {
    ...
    if (_token) {
        [_propertyListRequest setValue:[NSString stringWithFormat:@"Bearer %@", _token] forHTTPHeaderField:@"authorization"];
    }
