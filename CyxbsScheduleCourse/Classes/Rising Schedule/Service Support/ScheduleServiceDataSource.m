...
- (UIView *)backgroundView {
    if (_backgroundView == nil) {
        ...
        [UIColor Light:UIColorHex(#FC80E8F0)
                  Dark:UIColorHex(#400000)];
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView
    ...
    if (kind == UICollectionElementKindSectionHeader) {
        ...
        if (cell.isCurrent && indexPath.section != 0) {
            ...
            self.backgroundView.frame = CGRectMake(attributes.frame.origin.x, 10, attributes.size.width, collectionView.frame.size.height + 10);
