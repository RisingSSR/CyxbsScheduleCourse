...
static NSString * const CyxbsWidgetSchedule = @"ScheduleWidget";
...
+ (nullable ScheduleCombineItem *)memoryItemForKey:(ScheduleIdentifier *)key forKeyName:(ScheduleWidgetCacheKeyName)keyName {
    ScheduleIdentifier *iden = [self memoryKeyForKey:key forKeyName:keyName];
